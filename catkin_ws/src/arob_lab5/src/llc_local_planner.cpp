...
#include "AROB_lab5/llc_local_planner.h"



//register this planner as a BaseLocalPlanner plugin
PLUGINLIB_EXPORT_CLASS(p09_llc_local_planner::LLCLocalPlanner,
nav_core::BaseLocalPlanner)


using namespace std;

namespace p09_llc_local_planner{
	...
	bool LLCLocalPlanner::computeVelocityCommands(geometry_msgs::Twist& cmd_vel){
		...
		(krho_*euclideanDistance(robot_pose.pose, goal.pose)) < 1 ? cmd_vel.linear.x = krho_*euclideanDistance(robot_pose.pose, goal.pose) : cmd_vel.linear.x = 1;
